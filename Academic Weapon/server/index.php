    ...
    <form method="POST" action="index.php" enctype="multipart/form-data">
        ...
        <textarea 
          ...
          placeholder="Enter a short description"></textarea>
           ...
           <label for="topics">Choose your topics</label>
...
function show(what){
  ...
  <div id="content">
    <h3> Recently Uploaded files in the Community Hub</h3>
<?php
while ($row = mysqli_fetch_array($result)) {
    if ($row['id'][0] === "1") {
        echo "<div id='img_div' onclick='location.href=\"".$row['image']."\"'>";
        echo "<h1 style='padding-left: 40px; padding-right: 20px; color: #fff;'>".$row["image_text"]."</h1>";
